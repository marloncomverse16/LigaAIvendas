...
export default function WhatsappWebPage() {
  ...
  // Função para carregar os contatos (mockados por enquanto)
  const loadContacts = async () => {
    try {
      setLoading(true);
      
      // Simula uma chamada de API (será substituída pelo endpoint real)
      setTimeout(() => {
        const mockContacts: Contact[] = [
          ...
          },
          {
            id: "9876543210@c.us",
            name: "Maria Oliveira",
            phone: "9876543210@c.us",
            lastMessage: "Podemos conversar sobre o projeto?",
  ...
  // Função para carregar as mensagens (mockadas por enquanto)
      ...
      setTimeout(() => {
        const mockMessages: Message[] = [
          ...
          },
          {
            ...
            timestamp: "2025-05-21T10:32:00",
            sender: "me",
            status: "read"
          },
          {
            id: "3",
            content: "Estou bem também! Queria conversar sobre aquele assunto que comentamos ontem.",
            timestamp: "2025-05-21T10:35:00",
            sender: "other",
            status: "read"
          },
          {
            id: "4",
            content: "Claro, podemos conversar sobre isso. O que você quer saber exatamente?",
            timestamp: "2025-05-21T10:38:00",
            sender: "me",
            status: "delivered"
          }
        ];
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      // Simula envio da mensagem para a API
      toast({
