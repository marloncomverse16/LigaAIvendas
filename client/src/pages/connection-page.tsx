                  ...
                  <div className="text-center space-y-4">
                    ...
                    <div className="bg-white p-6 mx-auto rounded-xl shadow-md">
                      <div className="w-56 h-56 relative mx-auto">
                        ...
                        {status.qrCode ? (
                          <div>
                            {/* Tentar primeiro como data URL ou HTTP URL */}
                            {status.qrCode.startsWith('data:') || status.qrCode.startsWith('http') ? (
                              <img 
                                ...
                                onError={(e) => {
                                  console.error("Erro ao carregar QR code como URL:", status.qrCode?.substring(0, 100));
                                  // Tentar como base64
                                  e.currentTarget.src = `data:image/png;base64,${status.qrCode}`;
                                  
                                  // Se base64 falhar, mostrar fallback
                                  e.currentTarget.onerror = () => {
                                    ...
                                    toast({
                                      ...
                                      description: "O QR code recebido está em formato inválido. Por favor, tente novamente.",
                                      variant: "destructive",
                                    });
                                  };
                                }}
                              ...
                              <img 
                                ...
                                className="w-full h-full"
                                onError={(e) => {
                                  console.error("Erro ao carregar QR code como base64:", status.qrCode?.substring(0, 30) + "...");
                                  toast({
                                    title: "Erro ao carregar QR code",
