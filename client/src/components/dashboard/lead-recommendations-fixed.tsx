      ...
      {isLoading ? (
        ...
        <div className="space-y-4">
          {recommendations.map((recommendation) => {
            const status = recommendation.status || "pendente";
            const badgeProps = getStatusBadgeProps(status);
            const creationDate = recommendation.createdAt ? new Date(recommendation.createdAt) : new Date();
                ...
                <div className="flex items-start space-x-3 flex-1">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center">
                      ...
                      <Badge className="ml-2" variant={badgeProps.variant}>
                        {badgeProps.text}
                      </Badge>
